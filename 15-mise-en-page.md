...
- **Container**. A une largeur de 1100px.
...
**Note:** la largeur sur le Container est définie avec `width`. Mais puisque nous sommes dans un contexte Flexbox, cela se comporte comme un `max-width`.
...
La largeur par défaut de 1100px sur l'élément Container peut être redéfini dans vos *Theme Styles*, pour correspondre à votre maquette.
